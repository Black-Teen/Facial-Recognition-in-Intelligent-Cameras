...
# mash_image = face_recognition.load_image_file("Charles-Macharia/mash.jpg")
# mash_face_encoding = face_recognition.face_encodings(mash_image)[0]

# Load a second sample picture and learn how to recognize it.
# Charles_image = face_recognition.load_image_file("Charles-Macharia/Monica/monica.jpg")
